<%@ Page Title="" Language="C#" MasterPageFile="~/Nav-Master.master" AutoEventWireup="true" CodeFile="Users-CenterGB.aspx.cs" Inherits="Users_CenterGB" %>
                        ...
                        <div class="box-content" style="background-color: #FFF;">
                            <div class="box-content">
                                <ul class="nav nav-tabs" >
                                    <li><asp:HyperLink ID="HyperLink2"  NavigateUrl="~/Users-Center.aspx" runat="server"  ForeColor="Red">普通商品</asp:HyperLink></li>                                   
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ConnectionStrings:Tuan Tuan GroupBuying%>" SelectCommand="Select * From t_OrdersSort Where OS_ID >=6"></asp:SqlDataSource>
                </div>
