<%@ Page Title="" Language="C#" MasterPageFile="~/Management-Master.master" AutoEventWireup="true" CodeFile="Edit_GroupBuying.aspx.cs" Inherits="Edit_GroupBuying" %>
            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" data-original-title="">
                        <h2><i class="glyphicon glyphicon-fire"></i>编辑团购活动页</h2>
                    </div>
                        ...
                        <div class="box col-md-12">
                            <form role="form">
                                <div class="form-group">
                                    <label>产品名称</label>
                                    <asp:TextBox ID="AddName" class="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>产品品牌</label>
                                    <asp:TextBox ID="AddBrand" class="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>产品类型</label>
                                ...
                                <div class="form-group">
                                    <label>市场价</label>
                                    <asp:TextBox ID="AddMarketPrice" class="form-control" runat="server" onkeyup="javascript:CheckInputIntFloat(this);"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>团购价</label>
                                ...
                                <div class="form-group">
                                    <label>团购人数底限</label>
                                    <asp:TextBox ID="TotleNumber" class="form-control" runat="server" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="8" onafterpaste="this.value=this.value.replace(/\D/g,'')"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <p class="help-block">请选择要重新发布的产品效果图。最多可上传五张。</p>
                                </div>
                                                            <div class="form-group">
                                ...
                                <p class="help-block" id="P1">请选择要重新发布的位于首页的产品效果图。只可上传一张。</p>
                            </div>
                                ...
                                <a href="Management-GroupBuying.aspx" class="btn btn-default">
