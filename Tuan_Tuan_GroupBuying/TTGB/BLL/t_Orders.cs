...
namespace TTGB.BLL
{
	...
	{
		private readonly TTGB.DAL.t_Orders dal=new TTGB.DAL.t_Orders();
		public t_Orders()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTGB.Model.t_Orders GetModelByCache(int O_ID)
		{
			
			string CacheKey = "t_OrdersModel-" + O_ID;
			...
			return (TTGB.Model.t_Orders)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Orders> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Orders> DataTableToList(DataTable dt)
		{
			List<TTGB.Model.t_Orders> modelList = new List<TTGB.Model.t_Orders>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTGB.Model.t_Orders model;
