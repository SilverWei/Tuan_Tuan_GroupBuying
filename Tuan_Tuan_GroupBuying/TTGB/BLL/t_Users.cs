...
namespace TTGB.BLL
{
	...
	{
		private readonly TTGB.DAL.t_Users dal=new TTGB.DAL.t_Users();
		public t_Users()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTGB.Model.t_Users GetModelByCache(int U_ID)
		{
			
			string CacheKey = "t_UsersModel-" + U_ID;
			...
			return (TTGB.Model.t_Users)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Users> DataTableToList(DataTable dt)
		{
			List<TTGB.Model.t_Users> modelList = new List<TTGB.Model.t_Users>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTGB.Model.t_Users model;
