...
namespace TTGB.BLL
{
	...
	{
		private readonly TTGB.DAL.t_OrdersSort dal=new TTGB.DAL.t_OrdersSort();
		public t_OrdersSort()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTGB.Model.t_OrdersSort GetModelByCache(int OS_ID)
		{
			
			string CacheKey = "t_OrdersSortModel-" + OS_ID;
			...
			return (TTGB.Model.t_OrdersSort)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_OrdersSort> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_OrdersSort> DataTableToList(DataTable dt)
		{
			List<TTGB.Model.t_OrdersSort> modelList = new List<TTGB.Model.t_OrdersSort>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTGB.Model.t_OrdersSort model;
