...
namespace TTGB.BLL
{
	...
	{
		private readonly TTGB.DAL.t_Goods dal=new TTGB.DAL.t_Goods();
		public t_Goods()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTGB.Model.t_Goods GetModelByCache(int G_ID)
		{
			
			string CacheKey = "t_GoodsModel-" + G_ID;
			...
			return (TTGB.Model.t_Goods)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Goods> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Goods> DataTableToList(DataTable dt)
		{
			List<TTGB.Model.t_Goods> modelList = new List<TTGB.Model.t_Goods>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTGB.Model.t_Goods model;
