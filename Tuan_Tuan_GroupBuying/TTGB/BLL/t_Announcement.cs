...
namespace TTGB.BLL
{
	...
	{
		private readonly TTGB.DAL.t_Announcement dal=new TTGB.DAL.t_Announcement();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public TTGB.Model.t_Announcement GetModelByCache(int A_ID)
		{
			
			string CacheKey = "t_AnnouncementModel-" + A_ID;
			...
			return (TTGB.Model.t_Announcement)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Announcement> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TTGB.Model.t_Announcement> DataTableToList(DataTable dt)
		{
			List<TTGB.Model.t_Announcement> modelList = new List<TTGB.Model.t_Announcement>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TTGB.Model.t_Announcement model;
