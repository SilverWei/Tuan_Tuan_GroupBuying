<%@ Page Title="" Language="C#" MasterPageFile="~/Management-Master.master" AutoEventWireup="true" CodeFile="Management-Orders.aspx.cs" Inherits="Management_Orders" %>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-edit"></i>
                        <asp:Label ID="Label1" runat="server" Text="待处理订单管理"></asp:Label></h2>
                ...
                <div class="box-content">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ConnectionStrings:Tuan Tuan GroupBuying%>" SelectCommand=" Select * From (Select [O_ID],sum(OG_TotalPrice)as OG_TotalPrice From [t_OrdersGoods] Left join t_Goods on t_Goods.G_ID=t_OrdersGoods.G_ID group by [O_ID]) as A Left join t_Orders on t_Orders.O_ID=A.O_ID Left join t_OrdersShippingMethod on t_OrdersShippingMethod.OSM_ID = t_Orders.OSM_ID Left join t_Users on t_Users.U_ID = t_Orders.U_ID Left join t_OrdersSort on t_OrdersSort.OS_ID = t_Orders.OS_ID Where t_Orders.OS_ID = 3 order by A.O_ID desc"></asp:SqlDataSource>
                </div>
            </div>
        </div>
        <!--/span-->
