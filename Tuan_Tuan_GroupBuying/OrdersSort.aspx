<%@ Page Title="" Language="C#" MasterPageFile="~/Nav-Master.master" AutoEventWireup="true" CodeFile="OrdersSort.aspx.cs" Inherits="OrdersSort" %>
                        ...
                        <div class="box-content" style="background-color: #FFF;">
                            <div class="box-content">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red">普通商品</asp:HyperLink></li>
                                    <li>
                                        <asp:HyperLink ID="HyperLink1" NavigateUrl="~/OrdersSortGB.aspx" runat="server" ForeColor="Red">团购商品</asp:HyperLink></li>
                                </ul>
                                ...
                                <telerik:RadListView ID="RadListView3" runat="server" AllowPaging="True" ItemPlaceholderID="item" PageSize="10" DataSourceID="SqlDataSource4">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="center">¥ <%#Eval("[O_TotalPrice]") %></td>
                                            <td class="center">
